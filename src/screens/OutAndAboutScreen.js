        ...
        >
          <div style={{ height: '47vh', overflow: 'scroll' }}>
            <ProjectInfo
              ...
              appDescription="Explore your world! Out n About 5 is a scavenger hunt game that challenges users to complete 5 tasks located at 5 new places within 5 miles of their location. It was made using a P.E.R.N Stack (PostgreSQL, Express, React, Node) as well as OpenStreetMap API and React Leaflet. This was a group project wtih myself and 2 other developers and was completed in one week during a Software Engineering Immsersive Course from General Assembly."
              appTechUsed={[
                'JavaScript',
                'HTML',
                'CSS',
              ...
              appGithub="https://github.com/LawrenceOL/out-n-about-5-front-end"
